"""Score dashboard and profile views for Howl."""
...
from howl.constants import Difficulty, DIFFICULTY_COLORS, get_rank
...
def render_score_dashboard(
    ...
    console.print(Panel(
        dashboard.rstrip(),
        title="[bold bright_yellow]HOWL SCOREBOARD[/bold bright_yellow]",
